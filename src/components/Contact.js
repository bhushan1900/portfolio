...
const Contact = () => {
  ...
  useEffect(() => {
    // Load personal info data for contact information
    ...
    <section id="contact" className="py-20 bg-primary">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-sm text-light-gray">Email</h4>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-sm text-light-gray">Location</h4>
                  <p className="text-base">{personalInfo.location}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-sm text-light-gray">Phone</h4>
          ...
          <form onSubmit={handleSubmit} className="bg-white/5 rounded-lg p-8 shadow-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded px-4 py-3 text-white focus:outline-none focus:border-secondary"
            ...
            <button
              type="submit"
              className={`px-8 py-3 bg-secondary text-primary rounded font-semibold transition-all hover:bg-secondary/80 ${
